    ...
    <>
      <nav
        className={`fixed top-0 w-full z-50 transition-all duration-500 ${
          isScrolled 
            ? "bg-white/20 backdrop-blur-xl border-b border-white/30 shadow-lg shadow-purple-100/20" 
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4 max-w-7xl relative">
          <div className="flex items-center justify-center sm:justify-between w-full">
            ...
            <button
              className="absolute right-4 top-1/2 transform -translate-y-1/2 md:hidden text-gray-600 hover:text-purple-500 transition-colors duration-300 p-2 rounded-full hover:bg-white/30 backdrop-blur-sm"
              onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
            >
              {isMobileMenuOpen ? (
                <X size={20} className="transition-transform duration-300 rotate-90" />
              ) : (
                <AlignJustify size={20} className="transition-transform duration-300 hover:rotate-12" />
              )}
            </button>
          </div>
        </div>
          ...
          <div className="fixed top-0 right-0 w-full max-w-sm h-full bg-white/95 backdrop-blur-xl shadow-2xl z-50 border-l border-white/30">
            <div className="p-6 pt-20">
              ...
              <div className="mb-8 text-center">
                ...
                <h3 className="font-display font-medium text-gray-700">Menu</h3>
              </div>

              <nav className="space-y-4">
                <button
                  onClick={() => scrollToSection("home")}
                  className="flex items-center w-full text-left text-gray-600 hover:text-purple-500 transition-all duration-300 py-3 px-4 rounded-xl hover:bg-purple-50/50 group"
                >
